function Sidebar() {
  return (
    ...
    <div className="mb-6">
      ...
      <button className="flex items-center px-4 py-3 rounded-xl hover:bg-white/10 transition text-white font-semibold w-full">Dashboard</button>
      <button className="flex items-center px-4 py-3 rounded-xl hover:bg-white/10 transition text-white font-semibold w-full">Top Gainers<span className="ml-auto w-2 h-2 rounded bg-white/30"></span></button>
