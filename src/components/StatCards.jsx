...
const StatCards = ({ btcPrice, ethPrice }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
    {/* Active credit */}
    <div className="backdrop-blur-xl bg-gradient-to-br from-[#23232b]/70 via-[#6d5dfc]/30 to-[#a18aff]/20 rounded-2xl p-8 shadow-2xl border border-[#a18aff]/30 flex flex-col justify-center items-center min-h-[160px] transition-all duration-300 hover:scale-105 hover:shadow-[0_4px_32px_0_#a18aff55] hover:border-[#a18aff]/60 cursor-pointer">
    ...
    {/* Payment goal */}
    <div className="backdrop-blur-xl bg-gradient-to-br from-[#23232b]/70 via-[#f6e58d]/30 to-[#fffbe6]/20 rounded-2xl p-8 shadow-2xl border border-[#f6e58d]/30 flex flex-col justify-center items-center min-h-[160px] transition-all duration-300 hover:scale-105 hover:shadow-[0_4px_32px_0_#f6e58dcc] hover:border-[#f6e58d]/60 cursor-pointer">
